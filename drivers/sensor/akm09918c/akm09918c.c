...
/*
 * RTIO Sensor V2 API implementation
 */

static int akm09918c_submit(const struct device *dev, struct rtio_iodev_sqe *iodev_sqe)
{
...
static int akm09918c_get_decoder(const struct device *dev,
