...
__attribute__((weak)) int chbsp_i2c_mem_write_nb(ch_dev_t *dev_ptr, uint16_t mem_addr,
...
/* Functions supporting controlling int pins of individual sensors (originally only controllable in
 * a group) */
