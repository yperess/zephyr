...
ZTEST_USER(test_dma_test, test_adc_sample_one_channel)
{
...
ZTEST_USER(test_dma_test, test_adc_sample_two_channels)
{
#if defined(ADC_2ND_CHANNEL_ID)
...
ZTEST_USER(test_dma_test, test_adc_asynchronous_call)
{
#if defined(CONFIG_ADC_ASYNC)
...
ZTEST(test_dma_test, test_adc_sample_with_interval)
{
...
ZTEST(test_dma_test, test_adc_repeated_samplings)
{
...
ZTEST_USER(test_dma_test, test_adc_invalid_request)
{
