...
/* export test cases */
ZTEST(dma_m2m_link_test, test_dma_m2m_chan0_1_major_link)
{
	zassert_true((test_task(0, 1) == TC_PASS), NULL);
}

ZTEST(dma_m2m_link_test, test_dma_m2m_chan0_1_minor_link)
{
	zassert_true((test_task(1, 0) == TC_PASS), NULL);
}

ZTEST(dma_m2m_link_test, test_dma_m2m_chan0_1_minor_major_link)
{
