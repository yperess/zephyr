 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_toggle)
{
 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_toggle_visual)
{
	const struct device *port;
	int val_expected;
	int ret;
 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_set_get_raw)
{
	const struct device *port;
	int val_expected;
	int ret;
 ...
 *   function.
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_set_get)
{
	const struct device *port;
	int val_expected;
	int ret;
 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_set_get_active_high)
{
	const struct device *port;
	int val_expected;
	int ret;
 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_pin_set_get_active_low)
{
	const struct device *port;
