 ...
 */
ZTEST(gpio_api_1pin_test, test_gpio_port_toggle)
{
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_masked_get_raw)
{
	const struct device *port;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_masked_get)
{
	const struct device *port;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_masked_get_active_high)
{
	const struct device *port;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_masked_get_active_low)
{
	const struct device *port;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_bits_clear_bits_raw)
{
	const struct device *port;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_bits_clear_bits)
{
	const struct device *port;
	gpio_port_value_t val_expected = 0;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_clr_bits_raw)
{
	const struct device *port;
	gpio_port_value_t val_expected = 0;
	int ret;
...
ZTEST(gpio_api_1pin_test, test_gpio_port_set_clr_bits)
{
	const struct device *port;
	gpio_port_value_t val_expected = 0;
	int ret;
