...
ZTEST(gpio_basic_test, test_gpio_callback_add_remove)
{
	zassert_equal(test_callback_add_remove(), TC_PASS,
		     NULL);
}

ZTEST(gpio_basic_test, test_gpio_callback_self_remove)
{
	zassert_equal(test_callback_self_remove(), TC_PASS,
		     NULL);
}

ZTEST(gpio_basic_test, test_gpio_callback_enable_disable)
{
