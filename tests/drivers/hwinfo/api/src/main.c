...
ZTEST(hwinfo_device_id_api_test, test_device_id_get)
{
...
ZTEST(hwinfo_device_id_api_test, test_get_reset_cause)
{
	uint32_t cause;
	ssize_t ret;
 ...
 * @}
 */
ZTEST(hwinfo_device_id_api_test, test_clear_reset_cause)
{
 ...
 * @}
 */
ZTEST(hwinfo_device_id_api_test, test_get_supported_reset_cause)
{
	uint32_t supported;
	ssize_t ret;
...
ZTEST_SUITE(hwinfo_device_id_api_test, NULL, NULL, NULL, NULL, NULL);
