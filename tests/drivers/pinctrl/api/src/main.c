 ...
 */
ZTEST(pinctrl_api_test, test_config_dev0)
{
 ...
 */
ZTEST(pinctrl_api_test, test_config_dev1)
{
	const struct pinctrl_state *scfg;
 ...
 */
ZTEST(pinctrl_api_test, test_lookup_state)
{
	int ret;
	const struct pinctrl_state *scfg;
 ...
 */
ZTEST(pinctrl_api_test, test_apply_state)
{
	int ret;
 ...
 */
ZTEST(pinctrl_api_test, test_update_states)
{
	int ret;
	const struct pinctrl_state *scfg;
...
ZTEST_SUITE(pinctrl_api_test, NULL, NULL, NULL, NULL, NULL);
