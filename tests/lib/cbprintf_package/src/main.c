...
ZTEST_SUITE(test_cbprintf_package, NULL, NULL, NULL, NULL, NULL);

ZTEST(test_cbprintf_package, test_cbprintf_package)
{
...
ZTEST(test_cbprintf_package, test_cbprintf_rw_str_indexes)
{
	int len0, len1, len2;
...
ZTEST(test_cbprintf_package, test_cbprintf_fsc_package)
{
	int len;
	static const char *test_str = "test %d %s";
	static const char *test_str1 = "lorem ipsum";
